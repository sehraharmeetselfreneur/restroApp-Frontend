        ...
        <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div key={foodItem._id} className="p-6 hover:bg-gray-50 transition-all duration-300">
                      <div className="flex gap-6">
                        ...
                        <div className="relative flex-shrink-0">
                          ...
                          <div className={`absolute -top-2 -right-2 w-6 h-6 border-2 ${
                            foodItem.isVeg ? 'border-green-500' : 'border-red-500'
                          } bg-white rounded flex items-center justify-center`}>
                            <div className={`w-3 h-3 rounded-full ${
                              foodItem.isVeg ? 'bg-green-500' : 'bg-red-500'
                            }`}></div>
                          </div>
                        </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              {/* Checkout Button */}
              <button className="w-full bg-gradient-to-r cursor-pointer from-orange-500 to-red-500 text-white py-4 px-6 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
