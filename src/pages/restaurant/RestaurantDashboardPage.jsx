...
import { 
  ...
  TrendingUp, MapPin, DollarSign, Package, Menu, X, Eye,
  Phone, Mail, Calendar, Award, Users, ChefHat, Globe, CheckCircle
} from "lucide-react";
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50">
      ...
      >
        <div className="h-full bg-white/90 backdrop-blur-sm shadow-2xl border-r border-gray-200/50 p-4 flex flex-col justify-center">
          ...
          <div className={`border-t border-gray-200 pt-4 flex justify-between items-center transition-all duration-300 ${
